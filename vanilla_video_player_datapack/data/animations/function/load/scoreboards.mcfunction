...
#新建视频尺寸控制计分板
scoreboard objectives add video_resolution_size dummy
scoreboard objectives add video_setting_resolution_size dummy

function animations:video_add/load/scoreboards

function animations:dialog/load/scoreboards