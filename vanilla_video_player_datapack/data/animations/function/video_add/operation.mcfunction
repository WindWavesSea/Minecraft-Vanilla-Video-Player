...
#加上上次计算值
scoreboard players operation #temp video_list += #max_value video_list
...
#给与计算值
$execute store result storage video:$(name) video.id int 1 run scoreboard players get #end video_list
