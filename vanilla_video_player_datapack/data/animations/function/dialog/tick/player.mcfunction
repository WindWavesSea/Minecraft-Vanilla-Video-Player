...
execute if score @s vvp.dialog.dialog_show matches 1.. run function animations:dialog/dialog/open_menu/execute
...
function animations:dialog/dialog/open_menu/2/tick