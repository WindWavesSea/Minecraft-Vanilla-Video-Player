...
$execute store result storage video:player_number_$(number)_video_play dialog.video_list.page_number int 1 run scoreboard players get #max_page_number temp.dialog.video_list_play.player.$(number)
