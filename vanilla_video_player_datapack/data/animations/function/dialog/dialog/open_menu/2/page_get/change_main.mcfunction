...
#$tellraw @s [{score:{nbt:"video:dialog.get_page.$(player_number)",objective:"get_data.change_page"}}]

#execute if score @s vvp.dialog.video_list.page_change matches 2 run say change_page_data_set

#say change_page_data_set
