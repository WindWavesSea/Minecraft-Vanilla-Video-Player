...
execute if score @s vvp.dialog.video_list.page_number matches 2.. run function animations:dialog/dialog/open_menu/2/change_page/next_change with storage video:dialog temp_change_page
