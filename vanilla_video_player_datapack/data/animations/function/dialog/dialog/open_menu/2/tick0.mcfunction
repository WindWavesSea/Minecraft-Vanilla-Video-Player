...
#say tick0
#获取视频信息
$function animations:dialog/dialog/open_menu/2/video_get/get with storage video:dialog.$(player_number) video_list_play.temp.video
...
#写入到新的nbt当中
$function animations:dialog/dialog/open_menu/2/add_page/add with storage video:dialog.$(player_number) video_list_play.temp.video
