...
$function animations:dialog/dialog/opem_menu/2/video_get/language_video_get with storage video:dialog.$(player_number) video_list_play.temp.video
...
$function animations:dialog/dialog/opem_menu/2/video_get/language_get with storage video:dialog.$(player_number) video_list_play.temp.video