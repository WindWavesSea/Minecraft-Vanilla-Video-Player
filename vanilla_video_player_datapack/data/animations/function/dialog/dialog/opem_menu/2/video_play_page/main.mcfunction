...
function animations:dialog/dialog/opem_menu/2/clear_page0/main

function animations:dialog/dialog/opem_menu/2/video_play_page/show_page with storage video:dialog_video_show
