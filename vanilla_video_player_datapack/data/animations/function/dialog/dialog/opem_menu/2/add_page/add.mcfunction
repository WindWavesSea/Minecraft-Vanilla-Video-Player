...
function animations:dialog/dialog/opem_menu/2/add_page/add_page {player_number:"$(player_number)"}
...
$function animations:dialog/dialog/opem_menu/2/add_page/add0 with storage video:dialog.$(player_number) video_list_play.temp.video
