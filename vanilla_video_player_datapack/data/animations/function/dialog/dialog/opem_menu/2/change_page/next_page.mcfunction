...
execute if score @s vvp.dialog.video_list.page_number < @s vvp.dialog.video_list.max_page_number run function animations:dialog/dialog/opem_menu/2/change_page/next_change with storage video:dialog temp_change_page
execute if score @s vvp.dialog.video_list.page_number = @s vvp.dialog.video_list.max_page_number run function animations:dialog/dialog/opem_menu/2/change_page/last_page/show_page
