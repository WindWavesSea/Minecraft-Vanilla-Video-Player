...
execute if score @s video_resolution_size matches 4 run return run function animations:dialog/dialog/player_setting/run/1/set {command:"remove",number:1,text1:"16",text2:"9"}
