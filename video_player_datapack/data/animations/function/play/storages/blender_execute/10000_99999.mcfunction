...
run return run function animations:play/storages/add_zero {frame_zero:"0000"}

execute \
if score @s video_frame_player matches 10..99 \
run return run function animations:play/storages/add_zero {frame_zero:"000"}

execute \
if score @s video_frame_player matches 100..999 \
run return run function animations:play/storages/add_zero {frame_zero:"00"}
